  ...
  <body class="goto-here">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">freshfoods@email.com</span>
					    </div>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="SellerSignup" class="nav-link">Seller</a></li>
	          <li class="nav-item"><a href="CustomerSignup" class="nav-link">Customer</a></li>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="pb-md-5">
	          	<p>Botanically, fruits and vegetables are classified depending on which part of the plant they come from. A fruit develops from the flower of a plant, while the other parts of the plant are categorized as vegetables. Fruits contain seeds, while vegetables can consist of roots, stems and leaves.</p>
							<p>Fruits and vegetables are low in fat, salt and sugar. They are a good source of dietary fibre. As part of a well-balanced, regular diet and a healthy, active lifestyle, a high intake of fruit and vegetables can help you to:
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <p>We get the fresh vegetables and fruits here,It's feasible to buy...HEALTHY FOOD ONLINE!!</p>
          </div>
        </div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Quick learner,Inspiration for millions and great motivater for the organisation.</p>
                    <p class="name"> Shrijah Raghunathan</p>
                    <span class="position">Business Technology Analyst</span>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Multitalented and self motivated person who believes in his own hardwork..</p>
                    <p class="name">Sai Krishna D</p>
                    <span class="position">Bussiness Technology Analyst</span>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Exigent in work,very intelligent and Hardworking.</p>
                    <p class="name">Sai Krishna D</p>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text text-center">
                    ...
                    <p class="name">Nilofar Fathima</p>
                    <span class="position">Associate Analysts</span>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Execellent in giving ideas.</p>
                    <p class="name">Sravani Pulla</p>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>Far far away, behind the word mountains, far from the countries you can't reach.</p>
